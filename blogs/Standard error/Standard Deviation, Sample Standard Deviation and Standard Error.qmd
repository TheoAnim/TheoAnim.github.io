...
Let's move away from the initial digression. I believe the second paragraph sets the tone for this article which is intended to highlight the distinction among (population) standard deviation, sample standard deviation and standard error of the sample mean of a distribution whose mean exits.
:::
